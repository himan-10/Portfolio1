        ...
        <div className="grid gap-12 md:grid-cols-2">
          ...
          <form onSubmit={sendEmail}>
            ...
            >
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    type="text"
                    name="name"
                    className="rounded-md border border-border-obsidian bg-card-obsidian/40 px-3 py-2 text-sm text-white placeholder:text-zinc-500 focus:border-brand-violet focus:outline-none transition-colors"
              ...
              <Button type="submit"
               className="w-full sm:w-auto bg-gradient-to-r from-brand-violet to-brand-indigo hover:from-brand-violet/90 hover:to-brand-indigo/90 text-white border-0 shadow-lg shadow-brand-violet/20 transition-all duration-300">
                Send Message
              </Button>
            </motion.div>
          </form>
